...
| VET-048 | Кнопки выбора типа протокола: текстовое название заменить на иконки | 1 |
| VET-049 | При добавлении и редактировании протокола скроллиться должен весь протокол кроме поля «Пациент» | 1 |
