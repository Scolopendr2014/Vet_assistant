...
| VET-060 | В форме редактирования протокола иконку типа протокола разместить слева от поля «Пациент» | 1 |
| VET-061 | В форме просмотра и редактирования протокола учесть нижнее меню телефона: подгонять верстку так, чтобы поля формы не перекрывались нижним меню | 1 |
...
- **Задача:** VET-002 … VET-009, VET-047, VET-048, VET-049, VET-050, VET-051, VET-052, VET-053, VET-055, VET-056, VET-057, VET-058, VET-059, VET-060, VET-061 → этот файл, секция «Задачи»
