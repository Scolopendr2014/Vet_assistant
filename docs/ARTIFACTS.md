...
| VET-037 | В админке по кнопке «Выход» не всегда попадаешь в список пациентов | исправлен | [BUGS.md](BUGS.md#vet-037) |
| VET-038 | После добавления протокола не обновляется список протоколов у пациента на экране | открыт   | [BUGS.md](BUGS.md#vet-038) |
...
|--------|--------------------------------------------------------|------|
| VET-002 | Фото в протоколе и в PDF (UI, хранение, вставка в PDF) | 1    |
...
| VET-018 | 9 | Запись и загрузка аудио                    | нет      |
| VET-019 |10 | STT, авто-заполнение полей                 | нет      |
| VET-020 |11 | Уточнение данных (диалог)                  | нет      |
...
| VET-027 |18 | Облачное распознавание (STT)               | нет      |
| VET-028 |19 | Приватный сервер STT                       | нет      |
| VET-029 |20 | Офлайн-режим STT                           | нет      |
| VET-030 |21 | Автовыбор провайдера (SttRouter)           | в работе |
| VET-031 |22 | Вход по паролю/PIN                         | сделано  |
| VET-032 |23 | Редактирование шаблонов протоколов         | нет      |
| VET-033 |24 | Управление справочниками                   | нет      |
| VET-034 |25 | Настройки валидации                        | нет      |
...
- **Баги:** `VET-001`, `VET-037` → [BUGS.md](BUGS.md#vet-001)
- **Задача:** VET-002 … VET-009 → этот файл, секция «Задачи»
