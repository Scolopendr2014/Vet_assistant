...
| VET-065 | Редактор шаблонов: добавление, удаление, редактирование разделов протокола (CRUD разделов) | 1.3 |
| VET-066 | Редактор шаблонов: тип раздела, привязка к справочнику или диапазону значений | 1.3 |
| VET-067 | Редактор шаблонов: задание порядка разделов в протоколе (сортировка, расположение) | 1.3 |
...
- **Баги:** `VET-001`, `VET-037`, `VET-038`, `VET-039`, `VET-040` … `VET-046`, `VET-054`, `VET-073`, `VET-074` → [BUGS.md](BUGS.md)
- **Задача:** VET-002 … VET-009 (VET-008 объединён с VET-064), VET-047 … VET-063, VET-065 … VET-069, VET-071, VET-072 → этот файл, секция «Задачи»
