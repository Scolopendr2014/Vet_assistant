...
| VET-119 | Профиль ветеринара: модель данных, хранение (Фамилия, Имя, Отчество, Специализация, Примечание) | бэклог |
| VET-120 | Форма настройки профиля ветеринара; размещение под шестерёнкой; меню вместо шестерёнки («Настройка профиля», «Вход администратора») | бэклог |
| VET-121 | Первый запуск: открывать форму профиля; при заполненном профиле — приветствие «Добро пожаловать <ФИО>» | бэклог |
| VET-122 | PDF: вывод данных профиля в нижнем колонтитуле одной строкой: <Специализация> <ФИО>. <Примечание> | бэклог |
...
- **Задача:** VET-002 … VET-009 (VET-008 объединён с VET-064), VET-047 … VET-063, VET-065 … VET-069, VET-071, VET-072, VET-076 … VET-098, VET-119 … VET-124 → этот файл, секция «Задачи»; карта регрессии VET-124 → [РЕГРЕССИОННОЕ_ТЕСТИРОВАНИЕ.md](РЕГРЕССИОННОЕ_ТЕСТИРОВАНИЕ.md)
