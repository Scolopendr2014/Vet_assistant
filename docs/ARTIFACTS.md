...
| VET-088 | Юнит-тесты импорта/экспорта (templateType, templateVersion) | 1.3 |
| VET-089 | Интеграционный тест: экспорт → импорт → открытие протокола | 1.3 |
...
| VET-093 | Экспорт/импорт шаблонов протоколов: экспорт из формы редактирования версии; импорт с проверкой ID+версия (добавить новую версию или обновить существующую) | 1.3 |
...
| VET-107 | Настройки «Показывать рамку» и «Тип рамки» заменить на одну «Рамка» (Нет/Прямоугольная/Скруглённая) с иконками | 1.3 |
...
- **Задача:** VET-002 … VET-009 (VET-008 объединён с VET-064), VET-047 … VET-063, VET-065 … VET-069, VET-071, VET-072, VET-076 … VET-098, VET-119 … VET-123 → этот файл, секция «Задачи»
