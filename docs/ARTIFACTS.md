...
| VET-057 | В карточке пациента в списке протоколов: тип протокола заменить на иконку, дату протокола разместить справа от иконки | 1 |
| VET-058 | В форме просмотра протокола: название типа протокола заменить на иконку, дату протокола разместить справа от иконки типа протокола | 1 |
| VET-059 | В форме просмотра протокола в разделе «Данные осмотра»: все наименования полей заменить на русские, как в форме добавления/редактирования протокола | 1 |
...
- **Задача:** VET-002 … VET-009, VET-047, VET-048, VET-049, VET-050, VET-051, VET-052, VET-053, VET-055, VET-056, VET-057, VET-058, VET-059 → этот файл, секция «Задачи»
